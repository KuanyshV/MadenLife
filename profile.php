...
if (!isset($_SESSION['user_id'])) {
 ...
 $sql = 'SELECT * FROM block WHERE customer_id='.$_SESSION['user_id'];
  $result = $connection->query($sql);
...
$tech_completed = in_array_r(10, $result);
            ?>
           <!--  <h3>Suierkul Nuermukhammed</h3><br>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>22 February 2003</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>nurekeee.013@gmail.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+7 707 137 69 03</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Nur-Sultan</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>University:</strong> <span>Astana IT University</span></li> -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Programming <i class="val"><?php 
  ...
  if($program_completed){
    echo '100';}
      ...
      echo '0';
            ...
            <div class="progress">
              <span class="skill">Art & Culture <i class="val"><?php 
              if($art_completed){
                echo 'completed'; 
  ...
  if($art_completed){
    echo '100';}
      ...
      echo '0';
            ...
            <div class="progress">
              <span class="skill">Social Activity <i class="val"><?php 
              if($social_completed){
                echo 'completed'; 
  ...
  if($social_completed){
    echo '100';}
      ...
      echo '0';
             ...
             <div class="progress">
              <span class="skill">Sport and Health <i class="val"><?php 
              if($sport_completed){
                echo 'completed'; 
            ...
            <div class="progress">
              <span class="skill">Reading <i class="val"><?php 
    ...
    echo '100';}
      ...
      echo '0';
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">National and classical music <i class="val"><?php 
              if($music_completed){
                echo 'completed'; 
  ...
  if($music_completed){
    echo '100';}
      ...
      echo '0';
            ...
            <div class="progress">
              <span class="skill">History <i class="val"><?php 
  ...
  if($history_completed){
    echo '100';}
      ...
      echo '0';
            ...
            <div class="progress">
              <span class="skill">Nature <i class="val"><?php 
              if($nature_completed){
                echo 'completed'; 
  ...
  if($nature_completed){
    echo '100';}
      ...
      echo '0';
            ...
            <div class="progress">
              <span class="skill">Technology <i class="val"><?php 
              if($tech_completed){
                echo 'completed'; 
  ...
  if($tech_completed){
    echo '100';}
      ...
      echo '0';
            ...
            <div class="progress">
              <span class="skill">Dance <i class="val"><?php 
              if($dance_completed){
                echo 'completed'; 
  ...
  if($dance_completed){
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Achievements</h2>
          <p>The amount of completed tasks, challenges, goals in specific areas etc.</p>
        </div><br><br>
...
<iframe src="https://calendar.google.com/calendar/embed?src=kanik600%40gmail.com&ctz=Asia%2FAlmaty" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
